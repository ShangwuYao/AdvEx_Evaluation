...
def mnist_tutorial(train_start=0, train_end=60000, test_start=0,
    ...
    label_smooth = .1
    Y_train = Y_train.clip(label_smooth / 102., 1. - label_smooth)
    ...
    #model = VGG16(include_top=False, weights='imagenet', input_tensor=None, input_shape=None, pooling=None, classes=102)
    LR = 1e-3
    CLASS_NUM = 102

    model = make_vgg16(lr=LR, class_num=CLASS_NUM, use_pretrained=use_pretrained)
    model.summary()
    ...
    #model_2 = cnn_model()
    #model_2 = VGG16(include_top=False, weights='imagenet', input_tensor=None, input_shape=None, pooling=None, classes=102)
    model_2 = make_vgg16(lr=LR, class_num=CLASS_NUM, use_pretrained=use_pretrained)
    #preds_2 = model_2(x)
    preds_2 = K.softmax(model_2(x))
